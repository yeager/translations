# locale-langpack/libgphoto2-6

2 rättade översättningsposter. Ursprung: `/usr/share/locale-langpack/sv/LC_MESSAGES/libgphoto2-6.mo`.
...
[Rättad PO](../../po/locale-langpack/libgphoto2-6.po) · [Original](../../original/locale-langpack/libgphoto2-6.po) · [Diff](../../diff/locale-langpack/libgphoto2-6.po.diff) · [Metadata](../../metadata/locale-langpack/libgphoto2-6.json)
...
Råträffar: l10n-lint 303 → 301, svlang 0 → 0. Kvarstående träffar är kandidater och innebär inte verifierade fel.
...
PO-rad: original 9598, rättad 9598.
...
PO-rad: original 8692, rättad 8692.
