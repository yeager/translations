 ...
 */
    ...
    */
    ...
    'accepted_if' => ':attribute måste godkännas när :other är :value.',
    'current_password' => 'Lösenordet är felaktigt.',
    'declined' => ':attribute måste nekas.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Det angivna värdet för :attribute har förekommit i ett dataläckage. Välj ett annat värde för :attribute.',
    ],
    ...
    'prohibits' => 'Fältet :attribute förbjuder att :other anges.',
    'email_list' => 'Den här e-postdomänen får inte användas på den här webbplatsen. Se webbplatsens vitlista för e-post.',
    'recaptcha' => 'Slutför reCAPTCHA.',
];
